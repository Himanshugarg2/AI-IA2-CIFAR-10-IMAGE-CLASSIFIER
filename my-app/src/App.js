  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-red-100 py-4 px-4 sm:py-8 md:py-12">
      ...
      <div className="max-w-6xl mx-auto bg-gradient-to-r from-red-600 to-red-700 py-6 px-6 rounded-t-2xl shadow-lg">
        <h1 className="text-3xl font-extrabold text-white text-center tracking-tight">CIFAR-10 Image Classifier</h1>
        <p className="text-red-100 text-center mt-2">Identify objects in your images with machine learning</p>
      </div>
          ...
          <div className="md:w-1/2 p-6 md:p-8 flex items-center">
            {prediction ? (
              ...
              <div className="w-full bg-gray-50 border border-gray-200 rounded-xl p-8 text-center">
                ...
                <h3 className="mt-4 text-lg font-medium text-gray-900">No classification yet</h3>
                <p className="mt-2 text-sm text-gray-500">
                  Upload an image and click the "Classify Image" button to see results.
                </p>
                <div className="mt-6">
